...
export const metadata: Metadata = {
  ...
  description:
    "Diyetisyen Ezgi Evgin Aktaş danışan portalı: beslenme programınızı telefonunuzdan takip edin, öğün hatırlatıcıları alın ve diyetisyeninizle anlık iletişim kurun.",
  alternates: { canonical: "https://ezgievginaktas.com/mobil-uygulamamiz" },
  robots: { index: true, follow: true },
  openGraph: {
    type: "website",
    url: "https://ezgievginaktas.com/mobil-uygulamamiz",
    title: "Mobil Uygulamamız — Danışan Portalı | Diyetisyen Ezgi Evgin Aktaş",
    description:
